...
def info_kalyan():
    return {
        "apiversion": "1",
        "author": "kalyan",  # TODO: Your Battlesnake Username
        "color": "#cc00cc",  # TODO: Choose color
...
def move_kalyan(game_state: typing.Dict) -> typing.Dict:
...
if __name__ == "__main__":
    dataFilePath = Path(__file__).parent / "snake_kalyan.json"
    rhandle = open(dataFilePath, "r")

    gamestate = json.load(rhandle)
    rhandle.close()
    print(move_kalyan(gamestate))